...
const Layout = ({ isAdmin = false }) => {
  ...
  const isLoggedIn = localStorage.getItem("tehnologijada_logged_in");
  ...
  const logOut = () => {
    signOut(auth)
      .then(() => {
        // Sign-out successful.
        navigate("/");
        localStorage.removeItem("tehnologijada_logged_in");
      })
      .catch((error) => {
        // An error happened.
        console.log(error);
        ...
        <div id="c-app__main">
          <div id="c-app__main__navigation">
            <div>
              <svg
                onClick={() =>
                  goToPage(!isLoggedIn ? "/odbojka" : "/admin/odbojka")
                }
              ...
              <svg
                onClick={() =>
                  goToPage(
                    !isLoggedIn ? "/stolni-tenis" : "/admin/stolni-tenis"
                  )
                }
                fill="#ffffff"
                className="c-app__main__navigation__item"
              ...
              <svg
                onClick={() => goToPage(!isLoggedIn ? "/sah" : "/admin/sah")}
                className="c-app__main__navigation__item"
                width="24px"
                height="24px"
              ...
              <svg
                onClick={() =>
                  goToPage(!isLoggedIn ? "/kosarka" : "/admin/kosarka")
                }
                fill="#ffffff"
                className="c-app__main__navigation__item"
                width="24px"
              ...
              <svg
                onClick={() =>
                  goToPage(!isLoggedIn ? "/futsal" : "/admin/futsal")
                }
                className="c-app__main__navigation__item"
                width="24px"
                height="24px"
              ...
              <svg
                onClick={() => goToPage(!isLoggedIn ? "/kros" : "/admin/kros")}
                className="c-app__main__navigation__item"
                width="24px"
                height="24px"
                viewBox="0 0 24 24"
              ...
              <svg
                onClick={() =>
                  goToPage(!isLoggedIn ? "/plivanje" : "/admin/plivanje")
                }
                fill="#ffffff"
                className="c-app__main__navigation__item"
                width="24px"
